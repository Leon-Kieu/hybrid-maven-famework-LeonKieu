...
public class Order_TestCase extends BaseTest {
	...
	public void TC04_Update_Shopping_Cart(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Update Shoping Cart 01: Click Go To Cart");
	...
	@Test
	public void TC06_CheckOut_Order_Visa_Master(Method method) {

	}
	
	@Test
	public void TC07_Re_Oder(Method method) {
