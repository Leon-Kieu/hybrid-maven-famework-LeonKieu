...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalContants.PROJECT_PATH + "/extentV5/ExtentReport.html");
		...
		extentReports.setSystemInfo("Company", "Anh IT");
		extentReports.setSystemInfo("Project", "NopCommerce");
		extentReports.setSystemInfo("Team", "Leon.Kieu");
